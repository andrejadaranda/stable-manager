        ...
        {days.map((day) => {
          ...
          return (
            <Link
              ...
              className={`min-h-[92px] md:min-h-[110px] p-1.5 flex flex-col gap-1 bg-white hover:bg-cream-soft/60 transition-colors ${inMonth ? "" : "opacity-45"}`}
            >
              <span className={`text-[12px] font-medium w-6 h-6 inline-flex items-center justify-center rounded-full ${isToday ? "bg-brand-600 text-white" : "text-ink-700"}`}>
                {day.getDate()}
              </span>
