...
function horseAsHorseRow(h: HorseProfileSummary): HorseRow {
  return {
    ...
    backup_contact_name:     h.backup_contact_name,
    backup_contact_phone:    h.backup_contact_phone,
    backup_contact_relation: h.backup_contact_relation,
    color:         h.color,
    sex:           h.sex,
    unique_number: h.unique_number,
    height_cm:     h.height_cm,
    discipline:    h.discipline,
    microchip_id:  h.microchip_id,
    passport_no:   h.passport_no,
    fei_id:        h.fei_id,
